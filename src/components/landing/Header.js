        ...
        <div className="header">
          <div className="w-container">
            ...
            <div className="hero-banner-div">
              <img sizes="(max-width: 767px) 100vw, (max-width: 991px) 728px, 940px" src={require("../../images/hero-ss-browser2x.png")}></img>
              <img className="hero-banner" sizes="(max-width: 767px) 100vw, (max-width: 991px) 728px, 940px" src={require("../../images/hero-ss.png")}></img>
            </div>
          </div>
        </div>
